...
function GridHelper(size, spacing, colour) {
    this.size = (size !== undefined) ? size : 100
    this.spacing = (spacing !== undefined) ? spacing : 1

    var material = new THREE.LineBasicMaterial({ color: (colour !== undefined) ? colour : 0x888888 })
...
GridHelper.prototype.update = function(size) {
    this.size = size
}
